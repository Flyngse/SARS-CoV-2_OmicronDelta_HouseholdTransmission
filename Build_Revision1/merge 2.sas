...
data data.Contact_house_4 ;
	set data.Contact_house_4 ;
		...
		rename VariantPCR_selected = VariantPCR_selected_index ;
		rename Suspected_omicron = Suspected_omicron_index ;
...
/*
proc means data = data.Contact_house_5X maxdec=4;
	var Partially_vaccinated Partially_vaccinated_index ;
run;
*/
...
proc sql;
	...
	as select distinct
						...
						PV.Suspected_omicron as Suspected_omicron_secondary,
...
data data.Contact_house_10 ;
	set data.Contact_house_9 ;
		...
		* Dummies for OR-interaction ;
		fully_vacc_no_omicron = 0 ;
		if Vaccination_status = "Fully vaccinated" and Suspected_omicron_index = 0 then fully_vacc_no_omicron = 1 ;
		booster_vacc_no_omicron = 0 ;
		if Vaccination_status = "Booster vaccinated" and Suspected_omicron_index = 0 then booster_vacc_no_omicron = 1 ;
		fully_vacc_yes_omicron = 0 ;
		if Vaccination_status = "Fully vaccinated" and Suspected_omicron_index = 1 then fully_vacc_yes_omicron = 1 ;
		booster_vacc_yes_omicron = 0 ;
		if Vaccination_status = "Booster vaccinated" and Suspected_omicron_index = 1 then booster_vacc_yes_omicron = 1 ;

		length Vacc_omicron_group $ 13 ;
		if Vaccination_status = "Not vaccinated" 		and Suspected_omicron_index = 0 then Vacc_omicron_group = "DEL_NoVacc" ;
		if Vaccination_status = "Fully vaccinated" 		and Suspected_omicron_index = 0 then Vacc_omicron_group = "DEL_FullVacc" ;
		if Vaccination_status = "Booster vaccinated" 	and Suspected_omicron_index = 0 then Vacc_omicron_group = "DEL_BoostVacc" ;
		if Vaccination_status = "Not vaccinated" 		and Suspected_omicron_index = 1 then Vacc_omicron_group = "OMI_NoVacc" ;
		if Vaccination_status = "Fully vaccinated" 		and Suspected_omicron_index = 1 then Vacc_omicron_group = "OMI_FullVacc" ;
		if Vaccination_status = "Booster vaccinated" 	and Suspected_omicron_index = 1 then Vacc_omicron_group = "OMI_BoostVacc" ;

		length Vacc_omicron_group_2 $ 25 ;
		if Vaccination_status_2 = "NoVacc_NoPrevInfect" 		and Suspected_omicron_index = 0 then Vacc_omicron_group_2 = "DEL_NoVacc_NoPrevInfect" ;
		if Vaccination_status_2 = "NoVacc_YesPrevInfect" 		and Suspected_omicron_index = 0 then Vacc_omicron_group_2 = "DEL_NoVacc_YesPrevInfect" ;
		if Vaccination_status_2 = "YesVacc_NoPrevInfect" 		and Suspected_omicron_index = 0 then Vacc_omicron_group_2 = "DEL_YesVacc_NoPrevInfect" ;
		if Vaccination_status_2 = "YesVacc_YESPrevInfect" 		and Suspected_omicron_index = 0 then Vacc_omicron_group_2 = "DEL_YesVacc_YESPrevInfect" ;
		if Vaccination_status_2 = "BoosterVacc" 				and Suspected_omicron_index = 0 then Vacc_omicron_group_2 = "DEL_BoosterVacc" ;
		if Vaccination_status_2 = "NoVacc_NoPrevInfect" 		and Suspected_omicron_index = 1 then Vacc_omicron_group_2 = "OMI_NoVacc_NoPrevInfect" ;
		if Vaccination_status_2 = "NoVacc_YesPrevInfect" 		and Suspected_omicron_index = 1 then Vacc_omicron_group_2 = "OMI_NoVacc_YesPrevInfect" ;
		if Vaccination_status_2 = "YesVacc_NoPrevInfect" 		and Suspected_omicron_index = 1 then Vacc_omicron_group_2 = "OMI_YesVacc_NoPrevInfect" ;
		if Vaccination_status_2 = "YesVacc_YESPrevInfect" 		and Suspected_omicron_index = 1 then Vacc_omicron_group_2 = "OMI_YesVacc_YESPrevInfect" ;
		if Vaccination_status_2 = "BoosterVacc" 				and Suspected_omicron_index = 1 then Vacc_omicron_group_2 = "OMI_BoosterVacc" ;


		* Dummies for OR-interaction _ index ;
		fully_vacc_no_omicron_index = 0 ;
		if Vaccination_status_index = "Fully vaccinated" and Suspected_omicron_index = 0 then fully_vacc_no_omicron_index = 1 ;
		booster_vacc_no_omicron_index = 0 ;
		if Vaccination_status_index = "Booster vaccinated" and Suspected_omicron_index = 0 then booster_vacc_no_omicron_index = 1 ;
		fully_vacc_yes_omicron_index = 0 ;
		if Vaccination_status_index = "Fully vaccinated" and Suspected_omicron_index = 1 then fully_vacc_yes_omicron_index = 1 ;
		booster_vacc_yes_omicron_index = 0 ;
		if Vaccination_status_index = "Booster vaccinated" and Suspected_omicron_index = 1 then booster_vacc_yes_omicron_index = 1 ;
		...
		* Laust ;
		vax_dummy = Suspected_omicron_index ;
		if Suspected_omicron_index = 1 and Vaccination_status = "Fully vaccinated" then vax_dummy = 1 ;
		if Suspected_omicron_index = 0 and Vaccination_status = "Fully vaccinated" then vax_dummy = 0 ;

		boost_dummy = Suspected_omicron_index ;
		if Suspected_omicron_index = 1 and Vaccination_status = "Booster vaccinated" then boost_dummy = 1 ;
		if Suspected_omicron_index = 0 and Vaccination_status = "Booster vaccinated" then boost_dummy = 0 ;
		...
		* partial vaccination ;
		*if fully_vaccinated_Date_index < PrDate_index ;
...
data data.Analysis_daily ;
	set data.Contact_house_10 ;
		...
		and 	'09dec2021'd <= PrDate_index <= '15dec2021'd  
		and Suspected_omicron_index ne . 
		;
		count = 1 ;
		if Suspected_omicron_index = 1 then variant = "Omicron" ;
		if Suspected_omicron_index = 0 then variant = "Delta" ;

		same_variant = 0 ;
		if Suspected_omicron_index = Suspected_omicron_secondary then same_variant = 1 ;
		if Suspected_omicron_secondary = . then same_variant = . ;
